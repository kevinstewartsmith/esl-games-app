...
export default function Overlay() {
    ...
    function loseALife() { setLives(lives - 1) }
    ...
    function loadAlphabet() {
        ...
        for (const letter in alphabet) {
            ...
            <Grid 
                ...
                item xs={0.46}
            >
                <h1 className='letter' key={letter} value={letter} onClick={letterClicked}>{alphabet[letter]}</h1>
            </Grid>)
        }
        return letters
    }
    ...
    return (
        <div>
            ...
            { gameOver ? 
            <div style={{position: 'fixed', top: "10vh", left: "10%", right: "10%", height: "80%"}}>
